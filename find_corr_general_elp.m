function [corr_kd_avg] = find_corr_general_elp(k_d,KuvSurf,drho,pc,nModes,nPols,naverage,L,dz,method,theta_modes,statmethod,polrotmethod)
...
parfor jj_var = 1:naverage
    ...
    corr_kd(jj_var)=1/D*trace(coupMat*coupMat_drift');
end
switch statmethod
    case 'median'
        corr_kd_avg=median(corr_kd,1);
    case 'mean'
        corr_kd_avg=mean(corr_kd,1);
end
fprintf(['\n'])
