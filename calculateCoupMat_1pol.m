function [CoupMatLPab] = calculateCoupMat_1pol(P,f0,Lspan,dz,XTavg,method,seed)
...
%         CoupMatLPabxy(z).c(1:1:nPols*nModes,1:1:nPols*nModes) = (CoupMatLPab(z).c(1:1:nModes,1:1:nModes));
%     end
end